...
return [
    ...
    */
    ...
    'channels' => [
        'stack' => [
            'driver' => 'stack',
            'channels' => ['single', 'sms', 'admin', 'errors'],
        ...
        // SMS API specific logging
        'sms' => [
            'driver' => 'daily',
            'path' => storage_path('logs/sms-api.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30, // Keep SMS logs for 30 days
            'replace_placeholders' => true,
        ],

        // Admin API specific logging
        'admin' => [
            'driver' => 'daily',
            'path' => storage_path('logs/admin-api.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30, // Keep admin logs for 30 days
            'replace_placeholders' => true,
        ],
        ...
        'providers' => [
            'driver' => 'daily',
            'path' => storage_path('logs/sms-providers.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
            'replace_placeholders' => true,
        ],
