...
return new class extends Migration
{
    ...
    {
        Schema::table('cached_sms_services', function (Blueprint $table) {
            $table->string('brand_name', 100)->nullable()->after('provider_name');
        });
    ...
    private function updateExistingRecords(): void
    {
        ...
        // Update all records in cached_sms_services with brand names
        foreach ($providerBrands as $provider => $brandName) {
            DB::table('cached_sms_services')
